...
const Purchasecreatelist = () => {
    ...
    const addPurchase = async () => {
        ...
        try {
            let purchase = await axios.post(SERVICE.PURCHASE_CREATE, {
                ...
                totaltaxamount: Number(totalalltaxamt == NaN || totalalltaxamt == undefined ? '0.00' : Number(totalalltaxamt)?.toFixed(2)),
        ...
        let userInputs = allProductsList.map((value, indexList) => {
            if (indexInput == indexList) {
                if (reference == "purchasetablechange") {
                    //purchase inclusive
                    if (inputValue == "Exclusive" || inputValue == "Inclusive") {
                    ...
                    if (value.purchasetabletax == "None") {
                        ...
                        if(inputValue == "None"){
                            if (value.sellingpricetax == "Exclusive") {
                                ...
                                //discount
                                if (value.distypemod == "None") {
                                    return { ...value, [productInputName]: inputValue, subtaxs:taxsubarray, purchasetaxrate:taxratevalue, disvaluemod:"0.00", differenceamt:"0.00", netcostafterdiscount:Number(netCost)?.toFixed(2),netcostbeforediscount:Number(netCost)?.toFixed(2),netcosttaxamount:"0.00",netcostwithtax:Number(netCost)?.toFixed(2),unitcostbeforediscount: Number(unitcost)?.toFixed(2),unitcostafterdiscount:Number(unitcost)?.toFixed(2),unitcosttaxamount: "0.00",unitcostwithtax:Number(unitcost)?.toFixed(2),purchaseexcludetax: Number(unitcost)?.toFixed(2), pruchaseincludetax: "0.00", incalpha: "", excalpha: getAlphaRate(Number(unitcost)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                                }
                                else if (value.distypemod == "Fixed" || value.distypemod == "Amount") {
                                    let discountValue = Number(value.enteramt) - Number(value.disvaluemod);
                                    ...
                                    return { ...value, [productInputName]: inputValue, subtaxs:taxsubarray, purchasetaxrate:taxratevalue, disvaluemod: Number(value?.disvaluemod)?.toFixed(2), differenceamt: Number(value?.disvaluemod)?.toFixed(2), netcostafterdiscount:Number(netCostAftdisc)?.toFixed(2),netcostbeforediscount:Number(netCostBeforedisc)?.toFixed(2),netcosttaxamount:"0.00",netcostwithtax:Number(netCostAftdisc)?.toFixed(2),unitcostbeforediscount: Number(unitcostbrfdisc)?.toFixed(2),unitcostafterdiscount:Number(unitcostaftdisc)?.toFixed(2),unitcosttaxamount: "0.00",unitcostwithtax:Number(unitcostaftdisc)?.toFixed(2),purchaseexcludetax: Number(unitcostaftdisc)?.toFixed(2), pruchaseincludetax: "0.00", incalpha: "", excalpha: getAlphaRate(Number(unitcostaftdisc)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                                }
                                else if (value.distypemod == "Percentage") {
                                    let disamt = Number(value.enteramt) * (Number(value.disvaluemod) / 100);
                                    // let totpiecedis = Number(value.quantitytotalpieces) * Number(disamt);
                            ...
                            if (value.sellingpricetax == "Exclusive") {
                                ...
                                if (value.distypemod == "None") {
                                    ...
                                    //sell tax amoount
                                    let selltax = Number(sellingExcludevaluetax) - Number(sellingExmargin);
                                    return { ...value, [productInputName]: inputValue,subtaxs:taxsubarray,purchasetaxrate:taxratevalue, differenceamt: Number(disamt)?.toFixed(2), disvaluemod: Number(value?.disvaluemod)?.toFixed(2), netcostafterdiscount:Number(netCostAfterdisc)?.toFixed(2),netcostbeforediscount:Number(netCostBeforedisc)?.toFixed(2),netcosttaxamount:Number(netatxamt)?.toFixed(2),netcostwithtax:Number(netCostAfterDisTax)?.toFixed(2),unitcostbeforediscount: Number(unitCostBeforedisc)?.toFixed(2),unitcostafterdiscount:Number(unitCostAfterdisc)?.toFixed(2),unitcosttaxamount: Number(unittaxamt)?.toFixed(2),unitcostwithtax:Number(unitCostAfterDisTax)?.toFixed(2),purchaseexcludetax: Number(purchaseDiscAftEx)?.toFixed(2), pruchaseincludetax: Number(purchaseDiscAftIn)?.toFixed(2), incalpha: getAlphaRateInc(Number(purchaseDiscAftIn)?.toFixed(0)), excalpha: getAlphaRate(Number(purchaseDiscAftEx)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                                }
                    ...
                    if (value.purchasetabletax == "None" && value.quantityunitstatus == true) {
                        if (value.purchasetax == "None" && value.sellingpricetax == "Exclusive" || value.sellingpricetax == "Inclusive") {
                            //selling price exclusive purchase price exclusive unit cost
                            let sellingvaluemargin = (Number(value?.enteramt) * (Number(value.margin) / 100));
                            let sellingExmargin = Number(value?.enteramt) + Number(sellingvaluemargin);
                            ...
                            //quantity
                            let netCost = Number(value?.enteramt) * Number(inputValue)
                            let unitcost = (Number(netCost)/Number(inputValue));
                            //discount
                            if (value.distypemod == "None") {
                                return { ...value, [productInputName]: inputValue, quantitytotalpieces:inputValue, disvaluemod:"0.00", differenceamt:"0.00", netcostafterdiscount:Number(netCost)?.toFixed(2),netcostbeforediscount:Number(netCost)?.toFixed(2),netcosttaxamount:"0.00",netcostwithtax:Number(netCost)?.toFixed(2),unitcostbeforediscount: Number(unitcost)?.toFixed(2),unitcostafterdiscount:Number(unitcost)?.toFixed(2),unitcosttaxamount: "0.00",unitcostwithtax:Number(unitcost)?.toFixed(2),purchaseexcludetax: Number(unitcost)?.toFixed(2), pruchaseincludetax: "0.00", incalpha: "", excalpha: getAlphaRate(Number(unitcost)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                            }
                            else if (value.distypemod == "Fixed" || value.distypemod == "Amount") {
                                let discountValue = Number(value?.enteramt) - Number(value.disvaluemod);
                                
                                //before disc netcost && unit 
                                let netCostBeforedisc = Number(value?.enteramt) * Number(inputValue)
                                let unitcostbrfdisc = (Number(netCostBeforedisc)/Number(inputValue));
                                //after disc netcost
                                let netCostAftdisc = Number(discountValue) * Number(inputValue)
                                let unitcostaftdisc = (Number(netCostAftdisc)/Number(inputValue));
                                ...
                                return { ...value, [productInputName]: inputValue, quantitytotalpieces:inputValue, disvaluemod: Number(value?.disvaluemod)?.toFixed(2), differenceamt: Number(value?.disvaluemod)?.toFixed(2), netcostafterdiscount:Number(netCostAftdisc)?.toFixed(2),netcostbeforediscount:Number(netCostBeforedisc)?.toFixed(2),netcosttaxamount:"0.00",netcostwithtax:Number(netCostAftdisc)?.toFixed(2),unitcostbeforediscount: Number(unitcostbrfdisc)?.toFixed(2),unitcostafterdiscount:Number(unitcostaftdisc)?.toFixed(2),unitcosttaxamount: "0.00",unitcostwithtax:Number(unitcostaftdisc)?.toFixed(2),purchaseexcludetax: Number(unitcostaftdisc)?.toFixed(2), pruchaseincludetax: "0.00", incalpha: "", excalpha: getAlphaRate(Number(unitcostaftdisc)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                            }
                            else if (value.distypemod == "Percentage") {
                                let disamt = Number(value?.enteramt) * (Number(value.disvaluemod) / 100);
                                // let totpiecedis = Number(value.quantitytotalpieces) * Number(disamt);
                    ...
                    else if (value.quantityunitstatus == true && value.purchasetabletax == "Exclusive" || value.purchasetabletax == "Inclusive") {
                        if(value.purchasetax == "None" && value.sellingpricetax == "Exclusive" || value.sellingpricetax == "Inclusive"){
                           //selling price exclusive purchase price exclusive unit cost
                           let sellingvaluemargin = (Number(value?.enteramt) * (Number(value.margin) / 100));
                           let sellingExmargin = Number(value?.enteramt) + Number(sellingvaluemargin);
                           ...
                           if (value.distypemod == "None") {
                            ...
                            //quantity
                            let netCostBefrTax = Number(purchaseIn) * Number(inputValue)
                            let unitcostBefrTax = (Number(netCostBefrTax)/Number(inputValue));
                            let netCostAftTax = Number(purchaseEx) * Number(inputValue)
                            let unitcostAftTax = (Number(netCostAftTax)/Number(inputValue));
                            let netatxamt = Number(netCostBefrTax) - Number(netCostAftTax);
                            let unittaxamt = Number(unitcostBefrTax) - Number(unitcostAftTax);
                            //discount
                            if (value.distypemod == "None") {
                                ...
                                //unit nad net cost before discount
                                let netCostBeforedisc = Number(value?.enteramt) * Number(inputValue)
                                let unitCostBeforedisc = (Number(netCostBeforedisc)/Number(inputValue));
                                
                                //unit and net cost after discount
                                let netCostAfterdisc = Number(discountValue) * Number(inputValue)
                                let unitCostAfterdisc = (Number(netCostAfterdisc)/Number(inputValue));
                                
                                //unit and net cost before disc with tax
                                let netCostBeforeDisTax = Number(purchaseDiscBfrEx) * Number(inputValue)
                                let unitCostBeforeDisTax = (Number(netCostBeforeDisTax)/Number(inputValue));

                                //unit and net cost after disc with tax
                                let netCostAfterDisTax = Number(purchaseDiscAftEx) * Number(inputValue)
                                let unitCostAfterDisTax = (Number(netCostAfterDisTax)/Number(inputValue)); 
                                ...
                                //sell tax amoount
                                let selltax = Number(sellingExcludevaluetax) - Number(sellingExmargin);
                                return { ...value, [productInputName]: inputValue, quantitytotalpieces:inputValue, differenceamt: Number(disamt)?.toFixed(2), disvaluemod: Number(value?.disvaluemod)?.toFixed(2), netcostafterdiscount:Number(netCostAfterdisc)?.toFixed(2),netcostbeforediscount:Number(netCostBeforedisc)?.toFixed(2),netcosttaxamount:Number(netatxamt)?.toFixed(2),netcostwithtax:Number(netCostAfterDisTax)?.toFixed(2),unitcostbeforediscount: Number(unitCostBeforedisc)?.toFixed(2),unitcostafterdiscount:Number(unitCostAfterdisc)?.toFixed(2),unitcosttaxamount: Number(unittaxamt)?.toFixed(2),unitcostwithtax:Number(unitCostAfterDisTax)?.toFixed(2),purchaseexcludetax: Number(purchaseDiscAftEx)?.toFixed(2), pruchaseincludetax: Number(purchaseDiscAftIn)?.toFixed(2), incalpha: getAlphaRateInc(Number(purchaseDiscAftIn)?.toFixed(0)), excalpha: getAlphaRate(Number(purchaseDiscAftEx)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                            }
                        ...
                        if (value.purchasetax == "None" && value.sellingpricetax == "Exclusive" || value.sellingpricetax == "Inclusive") {
                            ...
                            let unitcost = (Number(netCost == 0 ? 1: netCost)/Number(resquantity == 0 ? 1 : resquantity));
                            //discount
                            if (value.distypemod == "None") {
                        ...
                        if(value.purchasetax == "None" && value.sellingpricetax == "Exclusive" || value.sellingpricetax == "Inclusive"){
                           ...
                           //quantity
                           let netCost = Number(value.enteramt) * Number(resquantity == 0 ? 1 : resquantity)
                           let unitcost = (Number(netCost == 0 ? 1: netCost)/Number(resquantity == 0 ? 1 : resquantity));
                           //discount
                           if (value.distypemod == "None") {
                               return { ...value, [productInputName]: inputValue, quantitytotalpieces:value.quantitynitpiece == "" || value.quantitynitpiece == 0 ? inputValue:resquantity, disvaluemod:"0.00", differenceamt:"0.00", netcostafterdiscount:Number(netCost)?.toFixed(2),netcostbeforediscount:Number(netCost)?.toFixed(2),netcosttaxamount:"0.00",netcostwithtax:Number(netCost)?.toFixed(2),unitcostbeforediscount: Number(unitcost)?.toFixed(2),unitcostafterdiscount:Number(unitcost)?.toFixed(2),unitcosttaxamount: "0.00",unitcostwithtax:Number(unitcost)?.toFixed(2),purchaseexcludetax: Number(unitcost)?.toFixed(2), pruchaseincludetax: "0.00", incalpha: "", excalpha: getAlphaRate(Number(unitcost)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                            ...
                            //quantity
                            let netCostBefrTax = Number(purchaseIn) * Number(resquantity == 0 ? 1 : resquantity)
                            let unitcostBefrTax = (Number(netCostBefrTax == 0 ? 1 : netCostBefrTax)/Number(resquantity == 0 ? 1 : resquantity));
                            let netCostAftTax = Number(purchaseEx) * Number(resquantity == 0 ? 1 : resquantity)
                            let unitcostAftTax = (Number(netCostAftTax == 0 ? 1 : netCostAftTax)/Number(resquantity == 0 ? 1 : resquantity));
                            let netatxamt = Number(netCostBefrTax) - Number(netCostAftTax);
                            let unittaxamt = Number(unitcostBefrTax) - Number(unitcostAftTax);
                            //discount
                            if (value.distypemod == "None") {
                   ...
                   //selling price exclusive purchase price exclusive unit cost
                   let sellingvaluemargin = (Number(value.purchaseexcludetax) * (Number(value.margin) / 100));
                   //sell bef tax
    ...
    balanceamt = ((balanceamtval ? balanceamtval : 0) - (Number(totalvalue))?.toFixed(2) ? Number(totalvalue)?.toFixed(2) : 0)
    ...
    function payDueCalc() {
        setPurchaseAdd(
            { ...purchaseAdd, paydue: totalvalue == undefined ? 0 : Number(totalvalue) - Number(purchaseAdd.payamount) }
        )
    }
  ...
  const handleDiscount = (e) =>{
    ...
    if (regex.test(inputValue) || inputValue === '') {
        if(purchaseAdd.discounttypemode == "None"){
            ...
            let disamt = Number(inputValue) * (Number(inputValue) / 100);
  ...
  const handleChangeDiscountMode = (value) =>{
        if(value == "None"){
            ...
            let disamt = Number(purchaseAdd.discountvaluemode) * (Number(purchaseAdd.discountvaluemode) / 100);

            let discountValue = Number(purchaseAdd.discountvaluemode) - Number(disamt);
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={6} sm={6} md={4} lg={4}>
                            ...
                            <Typography variant="subtitle1"
                                ...
                                onChange={(e) => { setPurchaseAdd({ ...purchaseAdd, nettotal: totalvalue }) }}
                            ><b> Net Total Amount:</b> ₹ {totalvalue}</Typography>
                        </Grid>
                    </Grid>
                </Box><br />
                <Box sx={userStyle.container}>
