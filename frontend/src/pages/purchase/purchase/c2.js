...
const Purchasecreatelist = () => {
    ...
    const productInputs = {
        produniqid:"",prodname:"",supplier:"",date:"",sku:"",hsn:"",hsntax:"",applicabletax: "",
        applicabletaxrate: "",lotnumber: "",purchasetabletax:"None",purchasetax: "None",purchasetaxrate:"",sellingpricetax:"",enteramt:"",margin: "",
        purchaseexcludetax:"",pruchaseincludetax: "",excalpha: "",incalpha: "",quantity: "",
        quantityunit: "None",quantitynitpiece:"",quantitysubunitpieces:1,quantitytotalpieces: "",quantityunitstatus: false,freeitem: "",freeitemunit:"None",freeitemtotalpieces:"",
        freeitemunitstatus:"",freeitemnitpiece:"",freeitemsubunitpieces:1,netcostafterdiscount:"",netcostbeforediscount:"",netcosttaxamount:"",netcostwithtax:"",unitcostbeforediscount: "",
        unitcostafterdiscount:"",unitcosttaxamount: "",unitcostwithtax:"",purchasenetcost:"",purchasenetcosttax: "",purchasenetcostaftertax: "",
        distypemod: "None",disvaluemod:"",differenceamt:"",ratebydismod:"",sellingpriceunitcost:"",sellingpriceunitwithoutcost: "",saletaxamount: ""
    }
    const [allProductsList, setAllProductsList] = useState([]);
    // purchase list og data only in add purchase
    const [purchaseAdd, setPurchaseAdd] = useState({
        supplier: "", referenceno: "", billamount: "", purchasedate: today, purchasetaxmode: "None", purchasetaxlabmode: "None", purchasestatus: "Pending", addressone: "", balance: 0,
        businesslocation: "", invoiceno: "", expenseamount: "", freightamount: "", totalamount: "", nettotal: 0.0, totalitem: 0,
    ...
    const handleChangeUnit = async (unitindex,valueunitname) =>{
        ...
        try {
            ...
            if(unitcompare.length == 0){
                ...
                await  productUserInput(unitindex, "quantityunit", valueunitname, "Quantityunit","",true,result[0]?.subquantity);
            }else{
                let result = valueunitname == "Pieces" || valueunitname == "Piece" || valueunitname == "pieces" || valueunitname == "piece" ? [{quantity:0,unitgrouping:valueunitname}] : unitcompare[0]?.unitgrouping == "Pieces" || unitcompare[0]?.unitgrouping == "Piece" || unitcompare[0]?.unitgrouping == "pieces" || unitcompare[0]?.unitgrouping == "piece" ? resunidata : resdata;
    ...
    function productUserInput(indexInput, productInputName, inputValue, reference = "", unituantityvalue, unitstatus, unitsubquantity, taxratevalue) {
                ...
                if (reference == "purchasetablechange") {
                    ...
                    if (inputValue == "Exclusive") {
                        if (value.sellingpricetax == "Exclusive") {
                            ...
                            return { ...value, [productInputName]: inputValue, enteramt: value.enteramt, purchaseexcludetax: value.enteramt, purchasetax: value.purchasetax, pruchaseincludetax: "", incalpha: "", excalpha: getAlphaRate(value.enteramt), sellingpriceunitcost: Number(sellingExcludevalue?.toFixed(0)) };
                            ...
                            if (value.enteramt) {
                                ...
                                return { ...value, [productInputName]: inputValue, enteramt: value.enteramt, purchasetax: value.purchasetax, purchaseexcludetax: purchaseextamtfixed, pruchaseincludetax: "", incalpha: "", excalpha: getAlphaRate(purchaseextamtfixed), sellingpriceunitcost: Number(sellingExcludevaluetax?.toFixed(0)) };
                            }
                    ...
                    //purchase exclusive
                        ...
                        if (value.sellingpricetax == "Exclusive") {
                            ...
                            let tax = taxRate == undefined || "" ? 0 : taxRate;
                    ...
                    if(value.purchasetabletax == "None"){
                        if (value.sellingpricetax == "Exclusive") {
                            ...
                            if (value.distypemod == "None") {
                                ...
                                return { ...value, [productInputName]: inputValue, purchasetaxrate:0, disvaluemod: Number(value?.disvaluemod)?.toFixed(2), differenceamt: Number(disamt)?.toFixed(2), netcostafterdiscount:Number(netCostAftdisc)?.toFixed(2),netcostbeforediscount:Number(netCostBeforedisc)?.toFixed(2),netcosttaxamount:"0.00",netcostwithtax:Number(netCostAftdisc)?.toFixed(2),unitcostbeforediscount: Number(unitcostbrfdisc)?.toFixed(2),unitcostafterdiscount:Number(unitcostaftdisc)?.toFixed(2),unitcosttaxamount: "0.00",unitcostwithtax:Number(unitcostaftdisc)?.toFixed(2),purchaseexcludetax: Number(unitcostaftdisc)?.toFixed(2), pruchaseincludetax: "0.00", incalpha: "", excalpha: getAlphaRate(Number(unitcostaftdisc)?.toFixed(0)),sellingpriceunitcost: Number(sellingExcludevaluetax)?.toFixed(2), sellingpriceunitwithoutcost:Number(sellingExmargin)?.toFixed(2), saletaxamount:(selltax)?.toFixed(2) }
                            }
                    ...
                    if(value.purchasetabletax == "None") {
                        if(value.quantityunitstatus == true){
                            ...
                            return { ...value, [productInputName]: inputValue, purchasenetcost: netCost?.toFixed(0), quantitytotalpieces:inputValue, ratebydismod: netCost?.toFixed(0) };
                        }else{
                            let res1 = Number(value.quantitysubunitpieces == "" || value.quantitysubunitpieces == 0 ? 1 : value.quantitysubunitpieces) * Number(value.quantitynitpiece)
                            ...
                            return { ...value, [productInputName]: inputValue, purchasenetcost: netCost?.toFixed(0), quantitytotalpieces:value.quantitynitpiece == "" || value.quantitynitpiece == 0 ? inputValue:resquantity, ratebydismod: netCost?.toFixed(0) };
                        }
                        
                    }
                    // else if(value.purchasetabletax == "Exclusive" && value.purchaseexcludetax) {
                    //     let netCost = Number(value.purchaseexcludetax) * Number(inputValue)
                    //     setAlltotalItems((alltotalitems) => {
                    //         let allItems = [...alltotalitems];
                    //         allItems[indexInput] = { ...totalItem, quantity: inputValue };
                    ...
                    if(unitstatus == true){
                        ...
                        return { ...value, [productInputName]: inputValue,netcostafterdiscount:"",netcostbeforediscount:"",netcosttaxamount:"", netcostwithtax:"",purchasenetcost: netCost?.toFixed(0), quantitytotalpieces:value.quantity,quantityunitstatus:true, quantitysubunitpieces:unitsubquantity, ratebydismod: netCost?.toFixed(0) };
                    }else{
                        ...
                        return { ...value, [productInputName]: inputValue,netcostafterdiscount:"",netcostbeforediscount:"",netcosttaxamount:"", netcostwithtax:"", purchasenetcost: netCost?.toFixed(0), quantitytotalpieces:resquantity,quantityunitstatus:false, quantitynitpiece:unituantityvalue,quantitysubunitpieces:unitsubquantity, ratebydismod: netCost?.toFixed(0) };
                    }
                    ...
                    if(unitstatus == true){
                        ...
                        return { ...value, [productInputName]: inputValue, freeitemtotalpieces:value.freeitem,freeitemunitstatus:true, freeitemsubunitpieces:unitsubquantity };
                    }else{
                        let res1 = Number(unitsubquantity) * Number(unituantityvalue)
            ...
            <form onSubmit={handleSubmit}>
                        ...
                        <Grid item md={2} sm={6} xs={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <OutlinedInput
                                    ...
                                    type="text"
                                    onChange={(e) => { setPurchaseAdd({ ...purchaseAdd, expenseamount: e.target.value }) }}
                                />
                            </FormControl>
                        </Grid>
                        <Grid item md={2} sm={6} xs={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <OutlinedInput
                                    ...
                                    type="text"
                                    onChange={(e) => { setPurchaseAdd({ ...purchaseAdd, freightamount: e.target.value }) }}
                                />
                            </FormControl>
                        </Grid>
                        <Grid item md={2} sm={6} xs={12}>
                            ...
                            <FormControl size="small" fullWidth>
                                <OutlinedInput
                                    ...
                                    type="text"
                                    onChange={(e) => { setPurchaseAdd({ ...purchaseAdd, totalamount: e.target.value }) }}
                                />
                            </FormControl>
                        </Grid>
                ...
                <Box sx={userStyle.container} style={{ minHeight: '300px', }}>
                                                        ...
                                                        <Grid container spacing={1}>
                                                            ...
                                                            <Grid item md={12}>
                                                                ...
                                                                <FormControl size="small" fullWidth>
                                                                    ...
                                                                    >
                                                                        <MenuItem value="None" onClick={(e) => handleChangeTax(i, "", 0)}>None</MenuItem>
                                                                        {taxrates && (
                                                                            taxrates.map((row, index) => (
                                                                                <MenuItem value={row.taxname + '@' + row.taxrate || row.hsn + '@' + row.taxrate} key={index} onClick={(e) => handleChangeTax(i, row.taxname + '@' + row.taxrate || row.hsn + '@' + row.taxrate, row.taxrate)}>{row.taxname + '@' + row.taxrate || row.hsn + '@' + row.taxrate}</MenuItem>
                                                                            ))
                                                                        )}
                                                                    </Select>
                                                                </FormControl>
                    ...
                    <Grid container>
                        ...
                        <Grid item xs={6} sm={6} md={4} lg={4}>
                            <Typography variant="subtitle1"><b>Total Tax Amount:</b>₹ {'00.0'}</Typography>
                        </Grid>
                    </Grid>
                </Box><br />
                <Box sx={userStyle.container}>
