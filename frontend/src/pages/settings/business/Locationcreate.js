...
function BusinessLocCreate({setbsLocations}) {
    ...
    //create pop up
    const [CreteOpen, setCreateOpen] = useState(false)
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        const isNameMatch = isBusilocationName.some(item => item.toLowerCase() === (businsLoca.locationname).toLowerCase());
...
const handleClear = ()=>{
    ...
    setBusinsLoca({ activate: false, name: "", locationname: "", locationid: "", landmark: "", address: "", city: "", zipcde: "", state: "", country: "", phonenumber: "", landlinenumber: "",
    email: "", website: "", onephonenumber: "", twophonenumber: "", threephonenumber: "", whatsappno: "", phonecheck: false,})
    ...
    return (
        <Box>
            <Grid sx={userStyle.spanPlusIcons} onClick={handleOpenCreate} ><AddCircleOutlineOutlinedIcon /></Grid>
            <Dialog
            ...
            >
                <>
                    <Box>
                        ...
                        <form>
                            <Typography sx={userStyle.HeaderText} style={{padding:"10px"}}>Add Business Locations</Typography>
                            <Box sx={userStyle.container}>
                                ...
                                <Grid container sx={userStyle.gridcontainer}>
                                    <Grid >
                                       <Button sx={userStyle.buttoncancel} onClick={ ()=>{handleClear(); handleCloseCreate()} } >CANCEL</Button>
...
export default BusinessLocCreate;