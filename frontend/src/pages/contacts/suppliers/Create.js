...
const accounttypes = [
   ...
   const handleAddInput = () => {
    ...
    const addAnotherSupplier = async () => {
        let codeslicespace = supplier.suppliername.replace(/[^a-zA-Z0-9]/g, '');
        let resultshotname = codeslicespace.slice(0, 4).toUpperCase();
        ...
        try {
            ...
            setSupplier({
                autogenerate: "", suppliername: "", addressone: "", addresstwo: "", country: { label: selectedCountry.name, value: selectedCountry.name }, state: { label: selectedState.name, value: selectedState.name },
                city: { label: selectedCity.name, value: selectedCity.name }, pincode: "", supplieremail: "", gstn: "", phoneone: "", phonetwo: "", phonethree: "", phonecheck: false,
                phonefour: "", landline: "", whatsapp: "", contactperson: "", creditdays: "", suppshortname: ""
            })
            setTodos([]);
            toast.success(req.data.message, {
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid container sx={userStyle.gridcontainer}>
                            <Grid >
                                ...
                                <Button sx={userStyle.buttonadd} onClick={handleAnotherSubmit} type="button">Save And Add Another</Button>
...
function Suppliercreate() {
    return (
        <>
             <Suppliercreatelist /><br /><br /><br /><br />
                    <Footer />
        </>
    );
}
